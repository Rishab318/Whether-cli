...
export const PURCHASE_PLAN: string = "Mobile";
// Product-lists
export const ProductListTitle: string = "Product list";
//defaultCountryName
export const defaultCountryName: string = "Spain (España)";
//planCodes
export const internationalMobilePlanSmall: string =
  "?accountType=RES&tariffCode=GS03SMSV&packageCode=PKGSMALL&bundle=";
export const internationalMobilePlanMedium: string =
  "?accountType=RES&tariffCode=GS03MDSV&packageCode=PKGMEDIU&bundle=";
export const internationalMobilePlanLarge: string =
  "?accountType=RES&tariffCode=GS03LGSV&packageCode=PKGLARGE&bundle=";
export const findMoreMobilePlanSmall: string = "small-mobile-plan/";
export const findMoreMobilePlanMedium: string = "medium-mobile-plan/";
export const findMoreMobilePlanLarge: string = "large-mobile-plan/";
...
// custom dropdown options fibre coverage
//osp-353 constant of available
export const AVAILABLE_COUNTRY = ["es", "us", "fr"];
...
//Bookmarks
export const ApplicationsTitle: string = "Application";
...
//Calender
export const CalendarBasicTitle: string = "Calendar Basic";
export const CalendarTitle: string = "Calendar";
...
export const ProjectCreatedHeading: string = "Project Created";
export const SalesOverviewsHeading: string = "Sales Overview";
export const MonthlyHistoryHeading: string = "Monthly  History";
export const LiveProductHeading: string = "Live Products";
export const TurnOverHeading: string = "Turn over";
export const CryptoCurrencyPriceHeading: string = "Cryptocurrency Prices";
export const CryptoAnnotationHeading: string = "Crypto Annotations";
...
export const ProjectTitleText: string = "Project Title";
...
export const ManageOrderHeading: string = "Manage Order";
export const StockReportHeading: string = "Stock Report";
export const ProjectDashboardTitle: string = "Project Dashboard";
export const TotalRevenueHeading: string = "Total Revenue";
export const TodayTaskHeading: string = "Today Task";
export const ProjectSummeryHeading: string = "Project Summery";
export const ProjectStatisticsHeading: string = "Project Statistics";
export const UpcomingDeadlinesHeading: string = "Upcoming Deadlines";
export const ProjectDeliveriesHeading: string = "Project Deliveries";
export const TeamMembersHeading: string = "Team Members";
//layout
...
export const OurGrowthHeading: string = "Our Growth";
export const ProductValuationHeading: string = "Product Valuation";
export const NotificationsHeading: string = "Notifications";
export const UserByCountryHeading: string = " User By Country";
export const DailyVisitorsHeading: string = "Daily Visitors";
export const TopProductHeading: string = "Top Product";
export const OpenInvoicesHeading: string = "Open invoices";
export const TotalEarningsHeading: string = "Total Earnings";
export const TotalExpensesHeading: string = "Total Expenses";

//Miscellaneous - Knowledgebase
export const Knowledgebase: string = "Knowledgebase";
...
export const UnlockingCreativity = "Preview Settings";
...
export const GoogleMap: string = "Google Map";
...
export const MdeFirstExample = "First Example";
...
//Miscellaneous - Support Ticket
export const Apps: string = "Apps";
export const SupportTicket: string = "Support Ticket";
...
export const LearningList: string = "Learning List";
...
export const DateLearning: string = "25 July 2024";
export const CommentTitleLearning: string = "Comment";
//Pages - sample page
export const Page: string = "Pages";
...
export const CallUsOn: string = "Call us on";
...
export const FirstNameWizardPlaceholder: string = "John";
...
export const BlogDetails: string = "Blog Details";
...
export const RangeSlider: string = "Range Slider";
...
export const FormattedLabels: string = "Formatted Label";
...
export const CrocsTheme: string = "Crocs Theme";
...
export const CreativeCard: string = "Creative Card";
...
export const TeresaMoselles: string = "Teresa J. Moselles";
...
export const OfwrriorCompany: string = "Ofwrrior Company";
...
export const BreadcrumbsTag: string = "Breadcrumb";

//Bonus Ui - Dropzone
export const Dropzone: string = "Dropzone";
...
//Bonus Ui - Scrollable
export const Scrollable: string = "Scrollable";
...
//Ui Kits
export const UiKitsTitle: string = "Ui Kits";
//Dropdown
...
export const OpenModalCrocs: string = "Open modal for Crocs";
export const CrocsSignUp: string = "Crocs SIGN-UP";
...
export const CrocsLogin: string = "Crocs Login";
export const CustomModalsTitle: string = "Crocs custom modals";
...
export const OutlineAlertTitle: string = "Outline Dark And Light Alerts";
...
//Helper Classes
export const HelperClassesTitle: string = "Helper Classes";
...
export const TextColorsBig: string = "Text Colors";
//Tag & Pills
export const TagPillsTitle: string = "Tag & Pills";
...
export const BadgeHeadingText: string = "Badge Heading";
...
export const PopoverTitleSmall: string = "Popover title";
...
export const DataSourceDataTablesTitle: string = "DATA Source DataTables";
...
export const StepFormWizardTitle: string = "Step Form Wizard";
...
export const ProjectDescription: string =
  " Select a project and write a description for it";
...
export const ProceedToBack: string = "Proceed to back";
...
//Form Controls
export const FormControlsTitle: string = "Form Controls";

//Checkbox & Radio
export const CheckboxRadioTitle: string = "Checkbox & Radio";
...
export const AgreePolicy: string =
...
export const FavoriteItemsTitle: string = "Select Your Favorite Items";
